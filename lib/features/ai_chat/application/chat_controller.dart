...
class ChatController extends StateNotifier<ChatState> {
  ...
  String _buildSystemPrompt(String reportSummary) {
    ...
    buf.writeln('不要使用 Markdown 标题（禁止使用 # 号），禁止使用 Markdown 表格、代码块或竖线分隔的列表；年份、概率等对比请写在普通段落里，例如「2026 丙午年：正缘约两成，婚姻几乎为零，主题是动荡与自我提升」。');
    buf.writeln('段落之间空一行，以纯文本段落呈现，回答应完整收束，不要写到一半中断。');
