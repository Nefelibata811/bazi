...
import '../features/history/infrastructure/bazi_records_local_cache.dart';
import '../features/history/infrastructure/collections_local_cache.dart';
...
Future<void> clearUserScopedSession(
  ...
  resetPreloadCoordinator();

  if (previousUserId != null) {
    await BaziRecordsLocalCache.clear(previousUserId);
    await CollectionsLocalCache.clear(previousUserId);
  }
